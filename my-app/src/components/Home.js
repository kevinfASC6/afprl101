    ...
    return (
        <div>
            ...
            <DropTable title="Early African History" > 
                ...
                millet and sorghum and settled along the river. As a result of this, Eygpt became one of the most densely populated regions of the ancient world. 
                Over the next 4000 years Eygpt began to develop into a thriving civilization despite their sparsely populated and harsh deserts, with irrigation 
                being developed along the Nile River and rulers know as Pharaohs who ruled their kingdoms from centralized governments. It dominated lands bordering 
                ...
                rise of the Mali Empire. It covered more than three times the land mass Ghana did at its peak. Mansa Musa, a devout muslim and the king of the 
                Mali Empire, completed his pilrimage in 1324 and through his dispersement of gold created a legendary image of Mali and promoted the treasures of 
                West Africa.</p> 
            ...
            <DropTable title="Transatlantic Slave Trade and Slavery">
                ...
                two million people died during the barbaric Middle Passage across the ocean." They were seperated by gender and forced to tightly pack together into 
                ...
                <p>Of the 11 million who made it across the Atlantic, around 90% of them arrived in the Carribbean and South America, with around 80% of Africans being 
                forced to work in sugar plantations with dangerous conditions. Work on plantations usually began at 5am in the morning, with the enslaved working until dawn in the Carribbean. 
             ...
             <DropTable title="The Colonization of Africa">
                ...
                <p>The British ruled their colonies indirectly. In Nigeria, the Gold Coast, Kenya, Uganda, and Tanganyika, Britian organized their colonies at the central, 
                    provicinal, or regional levels, with a governor or governor-general who governed with an appointed executive council and a legislative council. British 
                    colonies were often divided into provinces that were headed by provincial commissoners or residents.</p> 
                <p>The French, on the other hand, established a highly centralized administrative system that was influenced by their tradition of extreme administrative 
                    ...
                    assimilation, where through accultration and education and meeting formal conditions to become French Africans.</p>
                <h4>Resistance to Colonialism in Africa</h4>
                <p>In response to the Berlin Conference and its subsequent effects, it resulted in Afircan political and diplomatic reponses which got no where, eventually 
                    ...
                    guerilla warfare or direct military engagement. In small scale societies, gurrilla warfare was the dominant type of resistance because of their size and the a
                    bsence of professional armies. Direct military engagement was used by centralized states like kingdoms and empires, which often had standing armies. 
             ...
             <DropTable title="Pan Africanism">
              <p>In "Pan-Africanism," Minkah Makalani notes that "Pan-Africanism represents the complexities of black political and intellectual thought over two hundred years." 
                ...
                not only share a common history, but also shares a common destiny. This belief has lead to interconnectedness within the black community, which has taken many forms, 
                with a huge impact on political thought.</p>  
                <h4>African Religious Identity, Pan-African Conferences, and the Last Pac</h4> 
                <p>Throughout the Americas, an African identity was apparent in the religous enslaved, who often practived religions that blended African deities and belief systems 
                with that of Christianity and Catholicism. This gave raise the Santería in Cuba, Vodun in Haiti and the Dominican Republic, and Candomblé in Brazil. While the enslaved 
                ...
                Turner, Alexander Crummell, Yakub Pasha, and African Methodist Episcopal Church bishop Alexander Walters. Topics that were discusses during the conference included 
                ...
                1900 in London's Westminister Town Hall. This conference drew delegates from all over the world, with  thirty-two delegates from Africa, the United States, the Caribbean, 
